...
CREATE TABLE `product_lotproduct` (
  ...
  `price_sale_store` int(20) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `product_lotproduct` (`id`, `product_id`, `product_size`, `lotproduct_id`, `inventory`, `price`, `price_sale`, `price_sale_store`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 1000, 800000, 700000, 600000, '2021-07-31 00:04:23', NULL),
(2, 2, 1, 2, 1000, 800000, 700000, 600000, '2021-07-31 00:36:42', NULL),
(3, 1, 1, 1, 2000, 800000, 700000, 600000, '2021-07-31 00:51:03', NULL),
(4, 1, 1, 1, 1000, 800000, 700000, 600000, '2021-08-12 04:41:32', NULL),
(5, 1, 1, 1, 1000, 800000, 700000, 600000, '2021-08-12 04:43:23', NULL),
(6, 3, 1, 3, 1000, 600000, 500000, 400000, '2021-08-19 02:48:28', NULL),
(7, 1, 3, 1, 2000, 650000, 600000, 550000, '2021-08-31 08:39:50', NULL),
(8, 1, 3, 7, 600, 600000, 550000, 500000, '2021-08-31 08:40:36', NULL),
(9, 1, 3, 1, 100, 700000, 650000, 600000, '2021-08-31 09:02:39', NULL),
(10, 1, 3, 8, 1000, 600000, 550000, 500000, '2021-08-31 09:54:04', NULL),
(11, 1, 2, 7, 10, 600000, 550000, 500000, '2021-08-31 10:19:04', NULL),
(12, 1, 3, 7, 10, 55555, 666666, 777777, '2021-08-31 10:31:11', NULL),
(13, 1, 1, 8, 200, 600000, 500000, 400000, '2021-08-31 10:31:55', NULL),
(14, 1, 3, 1, 10, 5555555, 6666666, 7777777, '2021-08-31 11:02:27', NULL),
(15, 23, 2, 10, 1000, 5500, 6655, 7755, '2021-09-01 06:41:23', NULL),
(16, 23, 2, 10, 100, 600000, 550000, 500000, '2021-09-01 06:45:15', NULL),
(17, 1, 2, 7, 10, 11111, 22222, 333333, '2021-09-01 07:15:07', NULL);
...
INSERT INTO `product_size` (`id`, `size_id`, `product_id`, `qty`, `price`, `price_sale`, `price_sale_store`, `created_at`, `updated_at`) VALUES
(74, 1, 4, 0, 0, 0, 0, NULL, NULL),
(75, 1, 5, 0, 0, 0, 0, NULL, NULL),
(76, 1, 6, 0, 0, 0, 0, NULL, NULL),
(77, 1, 7, 0, 0, 0, 0, NULL, NULL),
(78, 1, 8, 0, 0, 0, 0, NULL, NULL),
(79, 1, 9, 0, 0, 0, 0, NULL, NULL),
(80, 1, 10, 0, 0, 0, 0, NULL, NULL),
(81, 1, 11, 0, 0, 0, 0, NULL, NULL),
(82, 1, 12, 0, 0, 0, 0, NULL, NULL),
(83, 1, 13, 0, 0, 0, 0, NULL, NULL),
(84, 2, 14, 0, 0, 0, 0, NULL, NULL),
(88, 1, 15, 0, 0, 0, 0, NULL, NULL),
(89, 3, 16, 0, 0, 0, 0, NULL, NULL),
(92, 3, 18, 0, 0, 0, 0, NULL, NULL),
(94, 2, 19, 0, 0, 0, 0, NULL, NULL),
(95, 3, 20, 0, 0, 0, 0, NULL, NULL),
(96, 2, 21, 0, 0, 0, 0, NULL, NULL),
(97, 1, 22, 0, 0, 0, 0, NULL, NULL),
(184, 1, 23, 0, 0, 0, 0, NULL, NULL),
(185, 2, 23, 0, 0, 0, 0, NULL, NULL),
(192, 1, 1, 0, 700000, 650000, 600000, NULL, '2021-09-01 10:03:43'),
(193, 2, 1, 0, 750000, 700000, 650000, NULL, '2021-09-01 10:03:43'),
(194, 3, 1, 0, 800000, 750000, 700000, NULL, '2021-09-01 10:03:43'),
(195, 4, 1, 0, 650000, 600000, 550000, NULL, '2021-09-01 10:03:43'),
(207, 1, 29, 0, 700000, 600000, 500000, NULL, '2021-09-01 10:00:01');
...
(1, 'Lô sản phẩm 01 - 180g', 2, 1, 790, 8000, '[\"1000\",\"2000\",\"1000\",\"1000\",\"2000\",\"100\",\"100\",\"10\"]', 100, 80, 500000, 3, '1122334455', '11223344', '2022-07-31', '2021-07-13 03:38:55', '2021-08-31 11:02:27'),
...
CREATE TABLE `uni_product` (
  ...
  `qty_in_box` int(10) DEFAULT NULL,
  `min_box` int(10) DEFAULT NULL,
  `price` bigint(20) DEFAULT NULL,
  `price_sale` bigint(20) DEFAULT NULL,
  `price_sale_store` bigint(20) DEFAULT NULL,
  `view_price` int(20) DEFAULT NULL,
  `view_price_sale` int(20) DEFAULT NULL,
  `view_price_sale_store` int(20) DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 0,
...
(1, '120g', 'hop-loai-1', 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị 01', 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị 01', 'Hộp loại 1 Hộp loại 1 Hộp loại 1 Hộp loại 1 Hộp loại 1', NULL, 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.', NULL, 1, 0, NULL, 'site-2-1628591074.jpg', NULL, NULL, '2021-07-13 03:17:48', '2021-08-10 03:24:37'),
(2, '150g', 'hop-loai-2', 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị 02', 'Hộp loại 2', 'Hộp loại 2', NULL, 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.', NULL, 1, 1, NULL, NULL, NULL, NULL, '2021-07-13 03:18:12', NULL),
(3, '180g', 'hop-loai-03', 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị 03', 'Hộp loại 03', 'Hộp loại 03', NULL, 'Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.Sốt Chấm là chất lỏng sánh, có độ đặc nhất định,có mùi thơm dịu nhẹ, được tạo nên từ nhiều loại gia vị, dùng để chấm hoặc ướp nấu, tăng cường mùi vị cho món ăn.', NULL, 1, 2, NULL, NULL, NULL, NULL, '2021-07-13 03:18:50', NULL),
(4, '210g', '90-g', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2021-09-01 04:25:54', NULL);
