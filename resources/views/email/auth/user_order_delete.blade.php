         ...
         <tbody>
            ...
            <tr>
               <td align="center" valign="top">
                  ...
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">{{ $uni_order['lang_code'] == 'vi' ? 'Chúng tôi đã hủy đơn hàng số':'We are very sorry to have to cancel your order number' }}: <b>{{ $uni_order['code_invoice'] }}</b> {{ $uni_order['lang_code'] == 'vi' ? 'theo yêu cầu của quý khách.  Bất cứ lúc nào quý khách hàng cũng có thể đặt mua những sản phẩm của chúng tôi tại UniMall, và chúng tôi luôn sẵn sàng phục vụ tới quý khách':'at your request. At any time, customers can order our products at UniMall, and we are always ready to serve you.' }}.</p>
                  </div>
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">{{ $uni_order['lang_code'] == 'vi' ? 'Chúng tôi luôn nỗ lực hoàn thiện chất lượng phục vụ và mong muốn quý khách hàng có trải nghiệm tuyệt vời khi mua sắm trên UniMall. Nếu trong quá trình mua sắm trên UniMall của chúng tôi, có điểm gì làm quý khách hàng chưa có trải nghiệm tốt hãy cho chúng tôi được biết ngay để có thể khắc phục chất lượng dịch vụ ngày càng tốt hơn':'
                     We always strive to improve the quality of service and hope that customers have a great experience when shopping on UniMall. If in the process of shopping on our UniMall, there is something that makes customers not have a good experience, please let us know right away so that we can fix the service quality better and better.' }}.
                  </div>
                  </td>
                  </tr>
                  </tbody>
