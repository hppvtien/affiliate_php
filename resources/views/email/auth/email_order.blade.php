...
<div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Xin chào khách hàng:':'Dear:' }} {{ $data_bill['customer_name'] }}</span></div>

<div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Quý khách đang có đơn hàng số':'You have invoice' }} {{ $data_bill['code_invoice'] }} {{ $data_bill['lang_code'] == 'vi' ? 'theo số đơn hàng được tạo vào ngày':'created on the date' }} {{ date_format($data_bill['created_at'], 'd-m-Y') }} {{ $data_bill['lang_code'] == 'vi' ? 'đang ở trạng thái chưa thanh toán.':'is in unpaid status.' }}</span></div>
...
<div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Xem hoá đơn được đính kèm theo email này':'See the order attached to this email.' }}: <a href="{{ route('get_user.generatePDF', 'data_id='.$data_bill['id']) }}" download>{{ $data_bill['lang_code'] == 'vi' ? '':'' }}{{ $data_bill['lang_code'] == 'vi' ? 'Xem chi tiết':'See details' }}</a></span></div>
</div>
</td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <div id="m_5063188309675374655body_content_inner" style="color:#636363;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
                                                                    ...
                                                                    <section>
                                                                        <h2 style="color:#0b2d25;display:block;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:18px;font-weight:bold;line-height:130%;margin:0 0 18px;text-align:left">
                                                                            {{ $data_bill['lang_code'] == 'vi' ? 'Thông tin đơn hàng':'Information line' }}</h2>
                                                                        <ul>
                                                                            <li>{{ $data_bill['lang_code'] == 'vi' ? 'Mã đơn hàng':'Code invoice' }}:
                                                                                <strong>{{ $data_bill['code_invoice'] }}</strong>
                                                                            </li>
                                                                            <li>{{ $data_bill['lang_code'] == 'vi' ? 'Ngày tạo':'Date' }}:
                                                                                <strong>{{ date_format($data_bill['created_at'], 'd/m/Y') }}</strong>
                                                                            </li>
                                                                            <li>{{ $data_bill['lang_code'] == 'vi' ? 'Địa chỉ':'Address' }}:
                                                                                <strong>{{ $data_bill['address'] }}</strong>
                                                                            </li>
                                                                            <li>{{ $data_bill['lang_code'] == 'vi' ? 'Số điện thoại':'Phone number' }}:
                                                                                <strong>{{ $data_bill['phone'] }}</strong>
                                                                            </li>
                                                                            <li>{{ $data_bill['lang_code'] == 'vi' ? 'Phương thức thanh toán':'Pay method' }}:
                                                                                <strong>{{ $data_bill['pay_node'] }}</strong>
                                                                            </li>
                                                                            <li>{{ $data_bill['lang_code'] == 'vi' ? 'Phương thức vận chuyển':'Shipping method' }}:
                                                                                @if ($data_bill['method_ship'] == 1)
                                                                                <strong>{{ $data_bill['lang_code'] == 'vi' ? 'Giao hàng nhanh':'Fast delivery' }}</strong>
                                                                                @else
                                                                                <strong>{{ $data_bill['lang_code'] == 'vi' ? 'Giao hàng tiết kiệm':'Save delivery' }}</strong>
                                                                                @endif
                                                                            </li>
                                                                        </ul>
                                                                    </section>
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    <th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                        {{ $data_bill['lang_code'] == 'vi' ? 'Sản phẩm':'Product' }}</th>
                                                                                    <th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                        {{ $data_bill['lang_code'] == 'vi' ? 'Số lượng':'Quantity' }}</th>
                                                                                    <th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                        {{ $data_bill['lang_code'] == 'vi' ? 'Đơn giá':'Price unit' }}</th>
                                                                                </tr>
                                                                            ...
                                                                            <tfoot>
                                                                                <tr>
                                                                                    <th scope="row" colspan="2" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                        {{ $data_bill['lang_code'] == 'vi' ? 'Tổng tiền':'Total amount' }}:</th>
                                                                                ...
                                                                                <tr>
                                                                                    <th scope="row" colspan="2" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                        {{ $data_bill['lang_code'] == 'vi' ? 'Phí ship':'Ship fee' }}:</th>
                                                                                    <td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                ...
                                                                                <tr>
                                                                                    <th scope="row" colspan="2" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left;border-top-width:4px">
                                                                                        {{ $data_bill['lang_code'] == 'vi' ? 'Tổng số thanh toán':'Total payment' }}:</th>
                  ...
                  <span style="
                     font-size: 20px;
                     ">
                  <b>{{ $data_bill['lang_code'] == 'vi' ? 'UniMall - Công ty TNHH Unikery':'UniMall - Unikery  Co., Ltd' }}&nbsp;</b>
                  </span>
                  </span>
                  </td>
                  </tr>
                  ...
                  <span style="
                     font-size: 16px;
                     ">{{ $data_bill['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span>
                  </div>
                  <div>
                  <span style="
                     font-size: 16px;
