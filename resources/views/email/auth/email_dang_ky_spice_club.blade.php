                ...
                <tr>
                    <td align="center" valign="top">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="
                                                                                                        ...
                                                                                                        <span style="
                                                                                                            font-size: 22px;
                                                                                                            ">
                                                                                                        <b>Dear {{ $userss['name'] }} {{ $userss['lang_code'] == 'vi' ? 'đã đăng ký tài khoản thành viên':'has registered for a member account' }} “ Spice Club” !</b>
                                                                                                        </span>
                                                                                                        </span>
                                                                                                    </td>
                                                                                                </tr>
                        ...
                        <td style="
                            ...
                            ">
                        <div>
                        <p style="font-size: 16px;margin-bottom: 10px!important;">{{ $userss['lang_code'] == 'vi' ? 'Hệ thống đã tiếp nhận yêu cầu đăng ký tài khoản từ Quý khách.':'The system has received the account registration request from you.' }}</p>
                        </div>
                        <div style="text-align: justify;">
                        <p style="font-size: 16px;margin-bottom: 10px!important;">
                            {{ $userss['lang_code'] == 'vi' ? 'Quý khách vui lòng nạp tiền để hệ thống kích hoạt tài khoản thành viên “Spice Club” cho quý khách với hướng dẫn dưới đây.':'Please make a deposit to activate your "Spice Club" member account with the instructions below.' }} </p>
                        </div>
                        </td>
                        </tr>
                        </tbody>
                        ...
                        <td colspan="2" style="padding:5px">{{ $userss['lang_code'] == 'vi' ? 'Hưỡng dẫn thanh toán phí đăng ký thành viên “spice club” :':'Instructions to pay the registration fee for "spice club" membership:' }}</td>
                        </tr>
                        <tr style="border: 1px solid #111;margin-left: 5px;">
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $userss['lang_code'] == 'vi' ? 'Email đăng ký':'Email registration' }}</td>
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $userss['email'] }}</td>
                        </tr>
                        <tr style="border: 1px solid #111;">
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $userss['lang_code'] == 'vi' ? 'Lệ Phí thành viên':'Membership Fee ' }}</td>
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;">50.000đ</td>
                        </tr>
                        <tr style="border: 1px solid #111;">
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $userss['lang_code'] == 'vi' ? 'Đăng nhập nạp tiền':'Login to top up' }}</td>
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;"><a href="{{ route('get.register.spiceclub') }}">{{ $userss['lang_code'] == 'vi' ? 'Đăng nhập':'Login' }}</a></td>
                        </tr>
                        </table>
                        </td>
                        </tr>
                        ...
                        <span style="
                            font-size: 16px;
                            ">{{ $userss['lang_code'] == 'vi' ? 'Các thông tin':'The information' }} </span>
                        </em>
                        <span style="
                            font-size: 16px;
                            ">Unimall</span>
                        ...
                        <span style="
                            font-size: 16px;
                            "> {{ $userss['lang_code'] == 'vi' ? 'cung cấp rất quan trọng, Quý khách vui lòng bảo mật nghiêm ngặt các thông tin này.':'provided is very important, please keep this information strictly confidential.' }} </span>
                        </em>
                        </div>
                        <div>
                        <em>
                        <span style="
                            font-size: 16px;
                            ">{{ $userss['lang_code'] == 'vi' ? 'Chúc quý khách tật hưởng những ưu đãi hấp dẫn khi trở thành thành viên của “Spice Club”.':'Wish you enjoy the attractive incentives when becoming a member of "Spice Club".' }} </span>
                        </em>
                        </div>
                        <div>
                        <em>
                        <span style="
                            font-size: 16px;
                            ">{{ $userss['lang_code'] == 'vi' ? 'Trân trọng cám ơn quý khách!':'Sincerely thank you!' }} </span>
                        </em>
                        </div>
                        </td>
                        </tr>
                        ...
                        <span style="
                            font-size: 20px;
                            ">
                        <b>{{ $userss['lang_code'] == 'vi' ? 'UniMall - Công ty TNHH Unikery':'UniMall – UNIKERY COMPANY LIMITED' }}&nbsp;</b>
                        </span>
                        </span>
                        </td>
                        </tr>
                        ...
                        <span style="
                            font-size: 16px;
                            ">{{ $userss['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span>
                        </div>
                        <div>
                        <span style="
                            font-size: 16px;
