<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><meta http-equiv="X-UA-Compatible" content="IE=edge" /><meta name="viewport" content="width=device-width, initial-scale=1" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="x-apple-disable-message-reformatting" /><meta name="apple-mobile-web-app-capable" content="yes" /><meta name="apple-mobile-web-app-status-bar-style" content="black" /><meta name="format-detection" content="telephone=no" /><title></title><style type="text/css">
    ...
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Xin chào khách hàng:':'Dear:' }} <b>{{ $data_bill['customer_name'] }}</b></span></div>
    @if ($data_bill['type_pay'] ==1)
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Quý khách đang có đơn hàng số':'You have invoice number' }} <b>{{ $data_bill['code_invoice'] }}</b>{{ $data_bill['lang_code'] == 'vi' ? 'được tạo vào ngày':'created on the date' }} {{ date_format($data_bill['created_at'], 'd-m-Y') }} {{ $data_bill['lang_code'] == 'vi' ? 'đang ở trạng thái chưa thanh toán.':'is in unpaid status.' }} </span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Quý khách có thể thanh toán từ bây giờ. Nếu quý khách đã đặt mua hàng và đây là đơn hàng gia hạn thì việc thanh toán trước ngày đến hạn thanh toán là':'You can pay from now and pay before the payment due date is' }} {{date_format(date_create($data_bill['end_date']),"d/m/Y") }} {{ $data_bill['lang_code'] == 'vi' ? 'sẽ giúp quý khách tránh bị lỡ hạn thanh toán.':'this will help you to avoid missed payment deadline. ' }} </span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">&nbsp;</span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Hình thức thanh toán của quý khách là: Chuyển khoản ngân hàng.':'Your payment method is Bank transfer. ' }}
    @else \
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Cám ơn Quý Khách đã đặt hàng tại UniMall,':'Thank you for ordering at UniMall,' }} </span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Quý khách đang có đơn hàng số':'You have invoice number' }} <b>{{ $data_bill['code_invoice'] }}</b>{{ $data_bill['lang_code'] == 'vi' ? '':'' }} {{ $data_bill['lang_code'] == 'vi' ? ' được tạo vào ngày':' created on the date' }} <b>{{ date_format($data_bill['created_at'], 'd-m-Y') }}</b>{{ $data_bill['lang_code'] == 'vi' ? '':'' }} {{ $data_bill['lang_code'] == 'vi' ? 'đang ở trạng thái chưa thanh toán.':'is in unpaid status.' }}</span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Quý khách sẽ được hệ thống UniMall cập nhật thông tin liên quan tới đơn hàng của mình như thời gian giao hàng, và tình trạng đơn hàng...':'You will be updated by UniMall’s system with information related to your order such as delivery time, and order status...
        ' }}</span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Hình thức thanh toán của quý khách là':'Your payment method is' }}: COD
    @endif </span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">&nbsp;</span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Tổng tiền phải thanh toán:':'Total amount to be paid:' }} @if ($data_bill['type_pay'] ==1)<b>{{ formatPdfVnd($data_bill['lang_code'],$data_bill['total_money']) }}</b>@else <b>{{ formatPdfVnd($data_bill['lang_code'],$data_bill['total_money']) }} {{ $data_bill['lang_code'] == 'vi' ? 'khi nhận được hàng':'when receiving the goods' }} </b> @endif</span></div>
    
    <div style="text-align: justify;"><span style="font-size:16px;">&nbsp;</span></div>
    @if ($data_bill['type_pay'] ==1)
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Ngày đến hạn thanh toán':'Due date for payment' }}: {{date_format(date_create($data_bill['end_date']),"d/m/Y") }}</span></div>
    @endif
    <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Xem hoá đơn được đính kèm theo email này':'See the order attached to this email.' }}: <a href="{{ route('get_user.generatePDF', 'data_id='.$data_bill['id']) }}" download>{{ $data_bill['lang_code'] == 'vi' ? 'Xem chi tiết':'See details' }}</a></span></div>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                        ...
                                                        <tr>
                                                            <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                                ...
                                                                <span style="color:#3c4858;"><span style="font-size:20px;"><strong>{{ $data_bill['lang_code'] == 'vi' ? 'Hướng dẫn thanh toán':'Payment instructions' }}</strong></span></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="10"></td>
                                                        ...
                                                        <tbody><tr>
                                                            <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                                ...
                                                                <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                    ...
                                                                    <tbody><tr>
                                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Quý khách chuyển khoản số tiền':'You transfer the amount' }} <b>{{ formatPdfVnd($data_bill['lang_code'],$data_bill['total_money']) }}</b>{{ $data_bill['lang_code'] == 'vi' ? 'vào một trong các tài khoản ngân hàng của UniMall':'to one of UniMall is bank accounts:' }}: </span></div></td>
                                                                    </tr>
                                                                    </tbody></table>
                ...
                <div style="background-color: rgb(255, 255, 255); border-radius: 0px;">
                    <table width="100%" cellpadding="0" border="0" cellspacing="0" name="Layout_10" id="Layout_10"><tbody><tr>
                        <td align="center" valign="top"><a href="#" name="Layout_10"></a>
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#ffffff" style="height: 0px; background-color: rgb(255, 255, 255); border-radius: 0px; border-collapse: separate; padding-left: 20px; padding-right: 20px;"><tbody>
                                <tr>
                                    <td class="rnb-container-padding" style="font-size: px;font-family: ; color: ;">
                                                    ...
                                                    <th class="rnb-force-col" align="left" style="text-align: center; font-weight: normal">
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                                        <span style="color:#3c4858;"><span style="font-size:20px;"><strong>{{ $data_bill['lang_code'] == 'vi' ? 'Ngân hàng Thương Mại Á Châu':'Asia Commercial Bank' }} (ACB)</strong></span></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="10"></td>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;">
                                                                        <div>
                                                                            <div style="text-align: justify;"><strong><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Chinh Nhánh: Thủy Nguyên – Hải Phòng':'Branch: Thuy Nguyen – Hai Phong' }}</span></strong></div>
                                                                            
                                                                            <div style="text-align: justify;"><span style="font-size:16px;"><strong>{{ $data_bill['lang_code'] == 'vi' ? 'Số tài Khoản:':'Account Number :' }}</strong> 888 666 888 68</span></div>
                                                                            
                                                                            <div style="text-align: justify;"><span style="font-size:16px;"><strong>{{ $data_bill['lang_code'] == 'vi' ? 'Chủ Tài Khoản':'Account Holder' }}</strong>: VŨ MẠNH ĐIỀU</span></div>
                                                                            
                                                                            <div style="text-align: justify;">&nbsp;</div>
                                                                            
                                                                            <div style="text-align: justify;">&nbsp;</div>
                                                                            
                                                                            <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Nội dung chuyển khoản quý khách vui lòng nhập':'Transfer content, please enter' }} {{ $data_bill['code_invoice'] }} {{ $data_bill['lang_code'] == 'vi' ? 'vào nội dung thanh toán để hệ thống tự động kích hoạt lưu giữ đơn hàng của bạn ngay khi UniMall nhận được thanh toán':'in the payment content so that the system will automatically activate and store your order as soon as UniMall receives the payment' }}.</span></div>
                                                                            
                                                                            <div style="text-align: justify;">&nbsp;</div>
                                                                            
                                                                            <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? 'Mọi thắc mắc vui lòng liên hệ với UniMall qua Hotline: 0356 105 899 hoặc email hotro@unimall.vn để được hỗ trợ tốt nhất.':'If you have any questions or concerns, please contact UniMall via Hotline:0356 105 899 or email hotro@unimall.vn for the best support.' }}.</span></div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <tbody><tr>
                                                            <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                                ...
                                                                <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                    ...
                                                                    <tbody><tr>
                                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div>
                                                                            <div style="text-align: justify;"><span style="font-size:16px;">{{ $data_bill['lang_code'] == 'vi' ? '}Quý khách đã là thành viên của Spice Club chưa? Với 50K ra nhập thành viên Spice Club ,  Quý khách sẽ được hưởng đặc quyền 5% khuyễn mãi dùng trọn đời và nhiều ưu đãi đặc biệt khác.':'Are you a member of Spice Club yet? With 50K joining Spice Club, you will enjoy the privilege of 5% lifetime promotion and many other special offers.' }} </span></div>
                                                                            <div style="text-align: justify;"><span style="font-size:16px;">&nbsp;</span></div>
                                                                         </td>
                                                                    </tr>
                                                                    </tbody></table>
                                                                        ...
                                                                        <tbody><tr>
                                                                            <td width="auto" valign="middle" bgcolor="#ea7236" align="center" height="40" style="font-size:18px; font-family:Arial,Helvetica,sans-serif; color:#ffffff; font-weight:normal; padding-left:20px; padding-right:20px; vertical-align: middle; background-color:#ea7236;border-radius:4px;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;">
                                                                                <span style="color:#ffffff; font-weight:normal;">
                                                                                        <a style="text-decoration:none; color:#ffffff; font-weight:normal;" target="_blank" href="{{ route('get.register.spiceclub') }}">{{ $data_bill['lang_code'] == 'vi' ? 'Đăng ký thành viên Spice Club':'Sign Up  for Spice Club membership' }}</a>
                                                                                    </span>
                                                                            </td>
                                                                        </tr></tbody></table>
                                                        ...
                                                        <tbody><tr>
                                                            <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                                ...
                                                                <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                    ...
                                                                    <tbody><tr>
                                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div><span style="font-size:16px;"><strong>{{ $data_bill['lang_code'] == 'vi' ? 'Công ty TNHH Unikery':'UniMall - Unikery  Co., Ltd' }}</strong></span></div>
    
    <div><span style="font-size:16px;">&nbsp;{{ $data_bill['lang_code'] == 'vi' ? '22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span></div>
    </td>
                                                                    </tr>
                                                                    </tbody></table>
                                                        ...
                                                        <tbody><tr>
                                                            <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                                ...
                                                                <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                    ...
                                                                    <tbody><tr>
                                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div style="text-align: center;"><span style="font-size:15px;">{{ $data_bill['lang_code'] == 'vi' ? '* Đây email tự động gửi từ hệ thống của UniMall; vui lòng không trả lời Email này':'* This email is automatically sent from UniMall is system; Please do not reply to this Email' }}.</span></div>
    
    <div style="text-align: center;">&nbsp;</div>
    
    <div style="text-align: center;"><span style="color:#0000FF;"><span style="font-size:16px;"> <a href="https://unimall.vn/">UniMall</a> | <a href="https://unimall.vn/san-pham/gia-vi-tu-nhien.html">{{ $data_bill['lang_code'] == 'vi' ? 'Gia Vị Tự Nhiên':'Natural Spice' }}</a> | <a href="https://unimall.vn/dang-nhap">{{ $data_bill['lang_code'] == 'vi' ? 'Đăng nhập tài khoản':'Signin  Account ' }}</a> |</span></span></div>
