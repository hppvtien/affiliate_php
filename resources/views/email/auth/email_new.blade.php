         ...
         <tbody>
            ...
            <tr>
               <td align="center" valign="top">
                  ...
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">{{ $data['lang_code'] == 'vi' ? 'Hệ thống':'' }} <b>UniMall</b> {{ $data['lang_code'] == 'vi' ? 'đã tiếp nhận yêu cầu đăng ký nhận bản tin của UniMall với email':'has received a request to subscribe to' }}: {{ $data['email'] }} <br>{{ $data['lang_code'] == 'vi' ? 'Quý khách vui lòng xác nhận bằng cách click vào nút Xác nhận đăng ký ở phía dưới để hoàn thành việc đăng ký':'Please confirm by clicking the Confirm Registration button below to complete the registration' }}.</p>
                  </div>
                  </td>
                  </tr>
                  </tbody>
                                                                                 ...
                                                                                 <tbody><tr>
                                                                                     <td width="auto" valign="middle" bgcolor="#ea7236" align="center" height="40" style="font-size:18px; font-family:Arial,Helvetica,sans-serif; color:#ffffff; font-weight:normal; padding-left:20px; padding-right:20px; vertical-align: middle; background-color:#ea7236;border-radius:4px;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;">
                                                                                         <span style="color:#ffffff; font-weight:normal;">
                                                                                                 <a style="text-decoration:none; color:#ffffff; font-weight:normal;" target="_blank" href="{{ route('verify.email.new', $data['code_verication']) }}">{{ $data['lang_code'] == 'vi' ? '':'' }}Xác nhận đăng ký</a>
                                                                                             </span>
                                                                                     </td>
                                                                                 </tr></tbody></table>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="font-size: 16px;margin-bottom: 10px!important;"><b>{{ $data['lang_code'] == 'vi' ? 'Chú ý':'Caution' }}:</b> {{ $data['lang_code'] == 'vi' ? 'Nếu bạn nhận được thư này do nhầm lẫn hoặc không muốn đăng ký, chỉ cần bỏ qua email này và không nhấp vào nút.':'If you received this message by mistake or don'.'t want to subscribe, just ignore this email and don'.'t click the button.' }}
                    </p>
                  </div>
                  ...
                  <span style="
                     font-size: 20px;
                     ">
                  <b>{{ $data['lang_code'] == 'vi' ? 'UniMall – UNIKERY COMPANY LIMITED':'UniMall - Công ty TNHH Unikery' }}&nbsp;</b>
                  </span>
                  </span>
                  </td>
                  </tr>
                  ...
                  <span style="
                     font-size: 16px;
                     ">{{ $data['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span>
                  </div>
                  <div>
                  <span style="
                     font-size: 16px;
