                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                                     ...
                                                                     <span style="font-size:22px;"><b>{{ $data['lang_code'] == 'vi' ? 'Kính gửi':'Dear' }}: {{ $data['name'] }}</b></span>
                                                                     </span>
                                                                  </td>
                                                               </tr>
                                                               <tr>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;">
                                                                     <div>
                                                                        <span style="font-size:18px;">{{ $data['lang_code'] == 'vi' ? 'Hệ thống đã tiếp nhận yêu cầu đăng ký tài khoản từ Quý khách':'The system has received the account registration request from you' }}.</span>
                                                                     </div>
                                                                     <div style="text-align: justify;">
                                                                        <span style="font-size:18px;">{{ $data['lang_code'] == 'vi' ? 'Quý khách vui lòng Click vào':'Please Click' }}
                                                                        <strong>{{ $data['lang_code'] == 'vi' ? ' Xác nhận đăng ký':' Confirm registration' }}</strong>
                                                                        {{ $data['lang_code'] == 'vi' ? ' ở dưới để tiếp tục':' below to continue' }}
                                                                        </span>
                                                                     </div>
                                                                  </td>
                                                               </tr>
                                                      ...
                                                      <th class="rnb-force-col" align="left" style="text-align: center; font-weight: normal">
                                                         <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                                     <span style="color:#3c4858;"><span style="font-size:22px;"><b>{{ $data['lang_code'] == 'vi' ? 'THÔNG TIN TÀI KHOẢN':'ACCOUNT INFORMATION' }}</b></span></span>
                                                                  </td>
                                                               </tr>
                                                               <tr>
                                                                  <td height="10">
                                                      ...
                                                      <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                         <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                            <tbody>
                                                               <tr>
                                                                  <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;">
                                                                     <div><span style="font-size:18px;">{{ $data['lang_code'] == 'vi' ? 'Email đăng nhập':'Email login' }}: {{ $data['email'] }}</span>
                                                                     </div>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td width="auto" valign="middle" bgcolor="#ea7236" align="center" height="40" style="font-size:18px; font-family:Arial,Helvetica,sans-serif; color:#ffffff; font-weight:normal; padding-left:20px; padding-right:20px; vertical-align: middle; background-color:#ea7236;border-radius:4px;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;">
                                                                     ...
                                                                     <a style="text-decoration:none; color:#ffffff; font-weight:normal;" target="_blank" href="{{ route('verify.email', $data['code_verication']) }}">{{ $data['lang_code'] == 'vi' ? 'Xác nhận đăng ký':'Registration confirmation' }}</a>
                                                                     </span>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                      ...
                                                      <th class="rnb-force-col" align="left" style="text-align: center; font-weight: normal">
                                                         <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                                     <span style="color:#3c4858;"><u><span style="font-size:20px;"><b>{{ $data['lang_code'] == 'vi' ? 'Chú ý':'Attention' }}:</b></span></u></span>
                                                                  </td>
                                                               </tr>
                                                               <tr>
                                                                  <td height="10">
                                                      ...
                                                      <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                         <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                            <tbody>
                                                               <tr>
                                                                  <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;">
                                                                     <div><em><span style="font-size:18px;">{{ $data['lang_code'] == 'vi' ? 'Các thông tin':'The information' }}
                                                                        </span></em><span style="font-size:18px;">Unimall</span><em><span style="font-size:18px;">
                                                                        {{ $data['lang_code'] == 'vi' ? 'cung cấp rất quan trọng, Quý khách vui lòng bảo mật nghiêm ngặt các thông tin này.':'provided is very important, please keep this information strictly confidential.' }}</span></em>
                                                                     </div>
                                                                     <div>
                                                                        <em>
                                                                        <span style="font-size:18px;">{{ $data['lang_code'] == 'vi' ? 'Trân trọng cám ơn quý khách!':'Sincerely thank you!' }}</span>
                                                                        </em>
                                                                     </div>
                                                                  </td>
                                                               </tr>
                                                      ...
                                                      <th class="rnb-force-col" align="left" style="text-align: center; font-weight: normal">
                                                         <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                                     <span style="color:#3c4858;"><span style="font-size:20px;">
                                                                     <b>
                                                                     {{ $data['lang_code'] == 'vi' ? 'UniMall - Công ty TNHH Unikery':'UniMall - Unikery  Co., Ltd' }}&nbsp;
                                                                     </b>
                                                                     </span>
                                                                     </span>
                                                                  </td>
                                                         ...
                                                         <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                            <tbody>
                                                               <tr>
                                                                  <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;">
                                                                     <div>
                                                                        <span style="font-size:18px;">{{ $data['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span>
                                                                     </div>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
