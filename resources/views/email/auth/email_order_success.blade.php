            ...
            <tr>
               <td align="center" valign="top">
                                                                        ...
                                                                        <tr>
                                                                           <td style="
                                                                              ...
                                                                              <span style="
                                                                                 font-size: 22px;
                                                                                 ">
                                                                              <b>{{ $uni_order['lang_code'] == 'vi' ? 'Xin chào khách hàng:':'Dear:' }} {{ $uni_order['customer_name'] }}</b>
                                                                              </span>
                                                                              </span>
                                                                           </td>
                                                                        </tr>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order['lang_code'] == 'vi' ? 'Cám ơn Quý khách đã thanh toán đơn hàng số':'Thank you for paying invoice' }} <b>{{ $uni_order['code_invoice'] }}</b> {{ $uni_order['lang_code'] == 'vi' ? '':'' }}theo số đơn hàng được tạo vào ngày <b>{{ date_format($uni_order['created_at'], 'd-m-Y') }}</b>.
</p>
                  </div>
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important;">
                     {{ $uni_order['lang_code'] == 'vi' ? 'Hình thức thanh toán của quý khách':'Your payment method' }} :  
                  @if ($uni_order['type_pay'] == 3)
                  {{ $uni_order['lang_code'] == 'vi' ? 'Thanh toán qua MOMO':'' }}
                  @elseif ($uni_order['type_pay'] == 4) 
                  {{ $uni_order['lang_code'] == 'vi' ? '':'Thanh toán qua VNPAY' }}
                  @elseif ($uni_order['type_pay'] == 1)
                  {{ $uni_order['lang_code'] == 'vi' ? 'Chuyển khoản':'Tranfer' }}
                  @endif</p>
                  </div>
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order['lang_code'] == 'vi' ? 'Xem chi tiết đơn hàng':'See details order' }}: <a  style="color: #0b2d25;" href="{{ route('get_user.generatePDF', 'data_id='.$uni_order['id']) }}">{{ $uni_order['lang_code'] == 'vi' ? 'Tại đây':'Here' }}</a></p>
                  </div>
                   <div style="text-align: justify;">
                  <p style="text-align: center;font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order['lang_code'] == 'vi' ? 'Để nhận được nhiều đặc quyền với những ưu đãi hấp dẫn, bạn hãy tham gia trở thành thành viên của câu lạc bộ Spice Club của UniMall':'To receive many privileges with attractive offers, please join to become a member of UniMall`s Spice Club' }} </p>
                  </div>
                  </td>
                  </tr>
                  </tbody>
                                                                                            ...
                                                                                            <tbody><tr>
                                                                                                <td width="auto" valign="middle" bgcolor="#ea7236" align="center" height="40" style="font-size:18px; font-family:Arial,Helvetica,sans-serif; color:#ffffff; font-weight:normal; padding-left:20px; padding-right:20px; vertical-align: middle; background-color:#ea7236;border-radius:4px;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;">
                                                                                                    <span style="color:#ffffff; font-weight:normal;">
                                                                                                            <a style="text-decoration:none; color:#ffffff; font-weight:normal;" target="_blank" href="{{ route('get.register.spiceclub') }}">{{ $uni_order['lang_code'] == 'vi' ? 'Đăng ký Spice Club':'Register for Spice Club Membership' }}</a>
                                                                                                        </span>
                                                                                                </td>
                                                                                            </tr></tbody></table>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order['lang_code'] == 'vi' ? 'Nếu quý khách gặp bất kỳ thắc mắc hay câu hỏi nào , vui lòng liên hệ với UniMall qua':'If you have any questions or concerns, please contact UniMall via' }} Hotline:<b>0356 105 899</b> {{ $uni_order['lang_code'] == 'vi' ? 'hoặc gửi email về':'or email' }} <b>hotro@unimall.vn</b> {{ $uni_order['lang_code'] == 'vi' ? 'để được hỗ trợ tốt nhất.':'for the best support.' }}
                    </p>
                  </div>
                  ...
                  <span style="
                     font-size: 20px;
                     ">
                  <b>{{ $uni_order['lang_code'] == 'vi' ? 'UniMall - Công ty TNHH Unikery':'UniMall - Unikery  Co., Ltd' }}&nbsp;</b>
                  </span>
                  </span>
                  </td>
                  </tr>
                  ...
                  <span style="
                     font-size: 16px;
                     ">{{ $uni_order['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span>
                  </div>
                  <div>
                  <span style="
                     font-size: 16px;
