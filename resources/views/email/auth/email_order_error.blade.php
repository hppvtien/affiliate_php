         ...
         <tbody>
            ...
            <tr>
               <td align="center" valign="top">
                                                                        ...
                                                                        <tr>
                                                                           <td style="
                                                                              ...
                                                                              <span style="
                                                                                 font-size: 22px;
                                                                                 ">
                                                                              <b>{{ $data_bill['lang_code'] == 'vi' ? 'Xin chào khách hàng:':'Hello customer:' }} {{ $data_bill['customer_name'] }}</b>
                                                                              </span>
                                                                              </span>
                                                                           </td>
                                                                        </tr>
                  ...
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">{{ $data_bill['lang_code'] == 'vi' ? 'Chúng tôi rất tiếc phải huỷ đơn hàng số: ':'We are very sorry to have to cancel your order number: ' }}<b>{{ $uni_order['code_invoice'] }}</b> {{ $data_bill['lang_code'] == 'vi' ? '':'' }}{{ $data_bill['lang_code'] == 'vi' ? 'của quý khách, vì lý do không nhận được thanh toán cho đơn hàng.  Bất cứ lúc nào quý khách hàng cũng có thể đặt mua những sản phẩm của chúng tôi tại UniMall, và chúng tôi luôn sẵn sàng phục vụ tới quý khách.':'due to the reason that payment has not been received for the order. At any time, customers can order our products at UniMall, and we are always ready to serve you.' }}</p>
                  </div>
                
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">{{ $data_bill['lang_code'] == 'vi' ? 'Chúng tôi luôn nỗ lực hoàn thiện chất lượng phục vụ và mong muốn quý khách hàng có trải nghiệm tuyệt vời khi mua sắm trên UniMall. Nếu trong quá trình mua sắm trên UniMall của chúng tôi, có điểm gì làm quý khách hàng chưa có trải nghiệm tốt hãy cho chúng tôi được biết ngay để có thể khắc phục chất lượng dịch vụ ngày càng tốt hơn.':'We always strive to improve the quality of our services and wish our customers a great experience when shopping on UniMall. If in the process of purchasing on our UniMall, is there anything that makes you not having a good experience; Please let us know  immediately so that we can improve the quality of service better and better.' }}
                </div>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="font-size: 16px;margin-bottom: 10px!important;">{{ $data_bill['lang_code'] == 'vi' ? 'Nếu quý khách gặp bất kỳ thắc mắc hay câu hỏi nào , vui lòng liên hệ với UniMall qua':'If you have any questions or concerns, please contact UniMall via' }} Hotline:<b>0356 105 899</b> {{ $data_bill['lang_code'] == 'vi' ? 'hoặc gửi email về':'or email' }} <b>hotro@unimall.vn</b> {{ $data_bill['lang_code'] == 'vi' ? 'để được hỗ trợ tốt nhất.':'for the best support.' }}
                    </p>
                  </div>
                  ...
                  <span style="font-size: 16px;">
                     {{ $data_bill['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}
                  </span>
                  </div>
                  <div>
                  <span style="
