            ...
            <tr>
               <td align="center" valign="top">
                                                                        ...
                                                                        <tr>
                                                                           <td style="
                                                                              ...
                                                                              <span style="
                                                                                 font-size: 22px;
                                                                                 ">
                                                                              <b>Dear: {{ $uni_order_sc['name'] }} {{ $uni_order_sc['lang_code'] == 'vi' ? 'đã thanh toán thành công phí thành viên của Spice Club !':'Spice Club membership fee has been successfully paid!' }}</b>
                                                                              </span>
                                                                              </span>
                                                                           </td>
                                                                        </tr>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="text-align: justify;font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Chúc quý khách có những trải nghiệm thú vị khi mua sản phẩm trên UniMall.vn với những ưu đãi riêng biệt cho thành viên của Spice Club.':'Wish you have an enjoyable experience when buying products on UniMall.vn with special offers for membership of Spice Club.' }} 
</p>
                  </div>
                  <div>
                  <p style="text-align: justify;font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Dưới đây là thông tin xác nhận về tài khoản thành viên của quý khách.':'Below is the confirmation information about your membership account.' }} 
</p>
                  </div>
                  </td>
                  </tr>
...
<tr>
                  ...
                  <td colspan="2">{{ $uni_order_sc['lang_code'] == 'vi' ? 'THÔNG TIN THÀNH VIÊN SPICE CLUB':'Spice club member account details' }}</td>
                  </tr>
                  <tr style="border: 1px solid #111;margin-left: 5px;">
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Tên tài khoản':'Account name' }}</td>
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $uni_order_sc['name'] }}</td>
                  </tr>
                  <tr style="border: 1px solid #111;">
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Mã đơn':'Code orders' }}</td>
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">#SC{{ $uni_order_sc['id'] }}</td>
                  </tr>
                  <tr style="border: 1px solid #111;">
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Lệ phí thành viên đã nạp':'Membership fee charged' }}</td>
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ formatVnd($uni_order_sc['price_nap']) }}</td>
                  </tr>
                  <tr style="border: 1px solid #111;">
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Giá trị tài khoản thành viên Spice Club':'Validity of Spice Club member account' }}</td>
                  <td align="left" style="padding-left: 5px;border-right: 1px solid;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Trọn đời':'Lifetime' }}</td>
                  </tr>
                  </tbody></table>
                  </td>
                  </tr>
                  ...
                  <span style="
                     font-size: 20px;
                     ">
                  <b>{{ $uni_order_sc['lang_code'] == 'vi' ? 'Chú ý':'Attention' }}:</b>
                  </span>
                  </u>
                  </span>
                  </td>
                  ...
                  <span style="
                     font-size: 16px;
                     ">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Các thông tin':'The infomation' }} </span>
                  </em>
                  <span style="
                     font-size: 16px;
                     ">Unimall</span>
                  ...
                  <span style="
                     font-size: 16px;
                     "> {{ $uni_order_sc['lang_code'] == 'vi' ? 'cung cấp rất quan trọng, Quý khách vui lòng bảo mật nghiêm ngặt các thông tin này.':'has provided is very important, please keep this information strictly confidential.' }} </span>
                  </em>
                  </div>
                  <div>
                  <em>
                  <span style="
                     font-size: 16px;
                     ">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Chúc quý khách tật hưởng những ưu đãi hấp dẫn khi trở thành thành viên của “Spice Club”':'Wish you enjoy the attractive incentives when becoming a member of "Spice Club"' }}. </span>
                  </em>
                  </div>
                  <div>
                  <em>
                  <span style="
                     font-size: 16px;
                     ">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Trân trọng cám ơn quý khách!':'Sincerely thank you!' }} </span>
                  </em>
                  </div>
                  </td>
                  </tr>
                  ...
                  <span style="
                     font-size: 20px;
                     ">
                  <b>{{ $uni_order_sc['lang_code'] == 'vi' ? 'UniMall - Công ty TNHH Unikery':'UniMall - Unikery  Co., Ltd' }}&nbsp;</b>
                  </span>
                  </span>
                  </td>
                  </tr>
                  ...
                  <span style="
                     font-size: 16px;
                     ">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Trụ sở chính: 22 Phố Mới, Thủy Sơn, Thủy Nguyên, Hải Phòng':'Head office: 22 New Street, Thuy Son, Thuy Nguyen, Hai Phong' }}</span>
                  </div>
                  <div>
                  <span style="
                     font-size: 16px;
