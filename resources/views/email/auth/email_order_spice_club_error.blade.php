            ...
            <tr>
               <td align="center" valign="top">
                  ...
                  <td style="
                     ...
                     color: #3c4858;
                     ">
                  <div style="text-align: justify;">{{ $uni_order_sc['lang_code'] == 'vi' ? '':'' }}
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Chúng tôi rất tiếc phải huỷ đơn hàng số: ':'We are very sorry to have to cancel your order number: ' }}: <b>#SC{{ $uni_order_sc['id'] }}</b> {{ $uni_order_sc['lang_code'] == 'vi' ? 'của quý khách, vì lý do không nhận được thanh toán nạp tiền cho tài khoản Spice Clup. Quý khách sẽ không nhận được bất cứ ưu đãi nào của tài khoản Spice Clup khi chưa thanh toán. Xin vui lòng':'due to not receiving the top-up payment for your Spice Clup account. You will not receive any benefits of Spice Club account without payment. Please' }} <a href="{{ route('get.recharge') }}">{{ $uni_order_sc['lang_code'] == 'vi' ? 'nạp tiền':'recharge' }}</a> {{ $uni_order_sc['lang_code'] == 'vi' ? 'cho tài khoản':'your account' }}</p>
                  </div>
                  </td>
                  </tr>
                  </tbody>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="font-size: 16px;margin-bottom: 10px!important;">{{ $uni_order_sc['lang_code'] == 'vi' ? 'Nếu quý khách gặp bất kỳ thắc mắc hay câu hỏi nào , vui lòng liên hệ với UniMall qua':'If you have any questions or concerns, please contact UniMall via' }} Hotline: <b>0356 105 899</b> {{ $uni_order_sc['lang_code'] == 'vi' ? 'hoặc gửi email về':'or email' }} <b>hotro@unimall.vn</b> {{ $uni_order_sc['lang_code'] == 'vi' ? 'để được hỗ trợ tốt nhất.':'for the best support.' }}
                    </p>
                  </div>
