    ...
    <div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
        <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10"
            ...
            <a href="../../demo7/dist/index.html">
                <img alt="Logo" src="{{ asset('media/logos/logo-demo7.svg') }}" class="h-35px" />
            </a>
        </div>
        <!--end::Logo-->
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                    <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                        style="background-image:url({{ asset('media/misc/dropdown-header-bg.png') }})">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="d-flex mb-10">
                                                    ...
                                                    <div class="scroll-y mh-200px mh-lg-350px">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{ asset('media/avatars/150-1.jpg') }}"
                                                                    alt="" />
                                                            </div>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{ asset('media/avatars/150-8.jpg') }}"
                                                                    alt="" />
                                                            </div>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{ asset('media/avatars/150-12.jpg') }}"
                                                                    alt="" />
                                                            </div>
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_61322df3d82da">
                                            <div class="px-7 py-5">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <div>
                                                        <select class="form-select form-select-solid"
                                                            ...
                                                            data-dropdown-parent="#kt_menu_61322df3d82da"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <a href="{{ route('users.index') }}"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                ...
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Quản lý Users
                                                </h5>


                                                <span class="text-gray-400 fw-bold">By SuperAdmin</span>
                                        ...
                                        <a href="{{ route('roles.index') }}"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                ...
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Quản lý Roles
                                                </h5>
                                        ...
                                        <a href="{{ route('products.index') }}"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                ...
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Quản lý Product
                                                </h5>
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="symbol symbol-40px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('media/svg/brand-logos/balloon.svg') }}"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="symbol symbol-40px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('media/svg/brand-logos/infography.svg') }}"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                ...
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Most Cloudy UMC
                                                </h5>
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                            <div class="mx-5">
                                ...
                                <!--end::Container-->
                                <div class="text-center px-4">
                                    <img src="{{ asset('media/illustrations/sigma-1/18.png') }}" alt=""
                            ...
                            <div class="mx-5">
                                ...
                                <div class="mb-12">
                                    ...
                                    <div class="d-flex align-items-center bg-light-primary rounded p-5 mb-7">
                                        ...
                                        <div class="flex-grow-1 me-2">
                                            <a href="../../demo7/dist/widgets/lists.html"
                                                class="fw-bolder text-gray-800 text-hover-primary fs-6">B &amp; Q - Food
                                                Company</a>
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_authors" role="tabpanel">
                            <div class="mx-5">
                                ...
                                <div class="mb-12">
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        <div class="symbol symbol-50px me-5">
                                            <img src="{{ asset('media/avatars/150-9.jpg') }}" class="" alt="" />
                                        </div>
                                        <!--end::Avatar-->
                                        <div class="flex-grow-1">
                                            <a href="../../demo7/dist/pages/projects/users.html"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-5">
                                            <img src="{{ asset('media/avatars/150-7.jpg') }}" class="" alt="" />
                                        </div>
                                        <!--end::Avatar-->
                                        <div class="flex-grow-1">
                                            <a href="../../demo7/dist/pages/projects/users.html"
