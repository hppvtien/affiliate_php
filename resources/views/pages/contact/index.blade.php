        ...
        <div class="column"><input name="form_key" type="hidden" value="km16CTJGtrby3Kv1">
                ...
                <div class="col-md-12 mt-5">
                    <div class="row">
                            ...
                            <div data-content-type="row" data-appearance="full-bleed" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}" data-background-type="image" data-video-loop="true" data-video-play-only-visible="true" data-video-lazy-load="true" data-video-fallback-src="" data-element="main" style="justify-content: flex-start; display: flex; flex-direction: column; background-position: left top; background-size: cover; background-repeat: no-repeat; background-attachment: scroll; border-style: none; border-width: 1px; border-radius: 0px; margin: 0px; padding: 0px;">
                                <div data-content-type="html" data-appearance="default" data-element="main" style="border-style: none; border-width: 1px; border-radius: 0px; margin: 0px; padding: 0px;" data-decoded="true">
                                    ...
                                    <div class="c-contact-information__block">
                                        ...
                                        <p>
                                            <b><i class="fa fa-building"></i></b> {{ getDataByLang($lang_code,$configuration->name,$configuration->name_en) }} 
                                        </p>
                                        <p>
                                            <b><i class="fa fa-map-marker" ></i></b> {{ getDataByLang($lang_code,$configuration->address,$configuration->address_en) }} 
                                        </p>
                                        <p>
                                            <b><i class="fa fa-envelope-o" ></i></b> {{ $configuration->email }}
                                        </p>
                                        <p>
                                            <b><i class="fa fa-volume-control-phone" ></i></b> {{ $configuration->hotline }} 
                                        </p>
                                    </div>

                                    <div class="c-contact-information__block" id="menu1abcd">
                                        <div class="uni-contact">
                                            {{ trans('title.info_contact_media') }}
                                        </div>
                                        <div class="link_share_contact">

                                            <!-- facebook -->
                                            <a class="facebook" href="{{ $configuration->facebook  }}" target="blank" rel="nofollow"><i class="fa fa-facebook"></i></a>

                                            <!-- twitter -->
                                            <a class="twitter" href="{{ $configuration->twitter }}" target="blank" rel="nofollow"><i class="fa fa-twitter"></i></a>

                                            <a class="pinterest" href="{{ $configuration->youtube }}" target="blank" rel="nofollow"><i class="fa fa-youtube"></i></a>

                                            <a class="facebook" href="{{ $configuration->instagram }}" target="blank" rel="nofollow"><i class="fa fa-instagram"></i></a>

                                            <!-- linkedin -->
                                            <a class="linkedin" href="{{ $configuration->linkedin }}" target="blank" rel="nofollow"><i class="fa fa-linkedin"></i></a>

                                            <!-- pinterest -->
                                            <a class="pinterest" href="{{ $configuration->pinterest }}" target="blank" rel="nofollow"><i class="fa fa-pinterest-p"></i></a>
                        ...
                        <div class="col-md-6" style="">
                            <img id="VISFXT1" style="width: 100%; height: auto;margin-top: 20px;" src="{{ asset('/images/icon_menu/anh-lien-he.jpg') }}" alt="{{ $configuration->name }}">
                        </div>
                    </div>
                </div>
            ...
            <div class="t-contact-us__form">
                <div class="c-contact-form">
                    <h2 class="c-contact-form__heading">{{ trans('title.info_contact_feedback') }}</h2>
                        ...
                        <div class="c-contact-form__fields fieldset">
                            <div class="c-contact-form__field c-contact-form__field--name field name required">
                                <div class="m-text-input m-text-input--placeholder-label control">
                                    ...
                                    <label class="a-form-label m-text-input__label label" for="name"><span>{{ trans('title.fullname') }}(*)</span></label>
                                </div>
                            ...
                            <div class="c-contact-form__field c-contact-form__field--phone field telephone">
                                <div class="m-text-input m-text-input--placeholder-label control">
                                    ...
                                    <label class="a-form-label m-text-input__label label" for="telephone"><span>{{ trans('title.phone_number') }}(*)</span></label>
                                </div>
                            ...
                            <div class="c-contact-form__field c-contact-form__field--message field comment required">
                                <div class="m-textarea m-textarea--placeholder-label control">
                                    ...
                                    <label class="a-form-label m-textarea__label label" for="comment"><span>{{ trans('title.content') }}(*)</span></label>
                                </div>
                        ...
                        <div class="actions-toolbar">
                            <div class="c-contact-form__submit primary">
                                ...
                                <button  data-url="{{ route('post.uni_contact') }}" id="submit-form-contact" type="button" title="Submit" class="a-btn a-btn--primary action submit primary">
                                    <span>{{ trans('title.info_contact_feedback') }}</span>
                                </button>
                            </div>
                        </div>
                    </form>
