                ...
                <div class="col-md-6">
                    ...
                    <div class="c-create-account__content" style="padding:0;margin-right:20px">
                        <div class="page-title-wrapper c-create-account__heading">
                            <h1 class="page-title">
                                <span class="base" data-ui-id="page-title-wrapper">{{ trans('title.account_regiter') }}</span>
                            </h1>
                        </div>
                                ...
                                <fieldset class="fieldsets create info">
                                    <div class="field field-name-firstname required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            ...
                                            <label class="a-form-label m-text-input__label label"
                                                for="firstname"><span>{{ trans('title.fullname') }}</span></label>
                                        </div>
                                    </div>
                                    <div class="field field-name-firstname required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            <input type="text" id="phone" name="phone" value="" title="phone"
                                                class="a-text-input m-text-input__input input-text required-entry">
                                            <label class="a-form-label m-text-input__label label"
                                                for="firstname"><span>{{ trans('title.phone_number') }}</span></label>
                                        </div>
                                    </div>
                                    <div class="field field-name-firstname required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                    ...
                                    <div class="m-checkbox field choice become_associate_member">
                                        ...
                                        <label for="associate_member_request" class="label">
                                            ...
                                            <span class="m-checkbox__text-label">{{ trans('title.become_store') }}</span>
                                        </label>
                                    </div>
                                </fieldset>
                                <fieldset class="fieldsets create account" data-hasrequired="* Required Fields">
                                    <div class="field required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            ...
                                            <label for="email_address"
                                                class="a-form-label m-text-input__label label"><span>{{ trans('title.email') }}</span></label>
                                        </div>
                                    </div>
                                    <div class="field password required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            ...
                                            <label for="password"
                                                class="a-form-label m-text-input__label label"><span>{{ trans('title.password') }}</span></label>
                                        </div>
                                    </div>
                                    <div class="field confirmation required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            ...
                                            <label for="password-confirmation"
                                                class="a-form-label m-text-input__label label"><span>{{ trans('title.re_password') }}</span></label>
                                        </div>
                                    </div>
                                    <div class="m-checkbox field choice become_associate_member">
                                ...
                                <div class="actions-toolbar">
                                    ...
                                    <div class="secondary">
                                        <a class="a-btn a-btn--text action back"
                                            href="{{ route('get.login') }}"><span>{{ trans('title.back') }}</span></a>
                                    </div>
                                </div>
