              ...
              <div class="layout__region layout__region--content">
                <div class="c-page-header c-page-header--light">
                  ...
                  <div class="c-page-header__content">
                    <h1 class="c-page-header__headline">{{ trans('title.news_unimall') }}</h1>
                  </div>
                </div>
                  ...
                  <nav class="m-breadcrumb" aria-label="Breadcrumb">
                    ...
                    <ol class="m-breadcrumb__list">
                      ...
                      <li class="m-breadcrumb__item m-breadcrumb__item--active">
                        <a class="a-anchor" aria-current="page">{{ trans('title.news_') }}</a>
                      </li>
                    </ol>
                  </nav>
                </div>
            ...
            <div class="layout layout--onecol">
              <div class="container row">
                  ...
                  <div class="col-md-2 d-none d-lg-block">
                    ...
                    <div class="mt-3 mb-3">
                      <a href="{{ getSlugPostCate(getDataByLang($lang_code,$item->slug,$item->slug_en)) }}" style="color: #000"> <i class="fa fa-fan"></i>
                      {{ getDataByLang($lang_code,$item->name,$item->name_en) }}</a>
                    </div>
                    @endforeach
                    ...
                    <div class="c-story-block {{ $key % 2 != 0 ? 'c-story-block--flipped':'' }}">
                      <div class="col-md-6">
                        <div class="c-story-block__content">
                          <h2 class="c-story-block__headline">{{ getDataByLang($lang_code,$item->name,$item->name_en) }}</h2>
                          <p class="c-story-block__description">{{ getDataByLang($lang_code,$item->desscription,$item->desscription_en) }}</p>
                          <div class="c-story-block__cta">
                            <a class="a-btn a-btn--secondary" href="{{ getSlugPost($item->slug) }}" title="{{ getDataByLang($lang_code,$item->name,$item->name_en) }}">{{ trans('title.show_detail') }}</a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-2 d-lg-none d-md-block">
                    @foreach ($post_category as $item)
                    <div class="mt-3 mb-3">
                      <a href="{{ route('get_blog.single_cat', ['slug' => $item->slug]) }}" style="color: #000"> <i class="fa fa-fan"></i>{{ getDataByLang($lang_code,$item->name,$item->name_en) }}</a>
                    </div>
                    @endforeach
