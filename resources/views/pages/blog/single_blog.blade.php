                            ...
                            <div class="col-md-12 row">
                              <div class="col-md-12 col-lg-6">
                                <nav aria-label="Breadcrumb"  class="mt-lg-5 mb-lg-5 pt-lg-3">
                                  ...
                                  <ol class="m-breadcrumb__list">
                                      ...
                                      <li class="m-breadcrumb__item">
                                          <a class="a-anchor" href="{{ getSlugPostCate($current_cate->slug) }}">{{ getDataByLang($lang_code,$current_cate->name,$current_cate->name_en) }}</a>
                                      </li>
                                      <li class="m-breadcrumb__item m-breadcrumb__item--active">
                                          <a class="a-anchor" aria-current="page">{{ getDataByLang($lang_code,desscription_cut($blog_post->name,30),desscription_cut($blog_post->name_en,30)) }}</a>
                                      </li>
                                  </ol>
                              </nav>
                              </div>
                              <div class="col-md-12 col-lg-6">
                                <div id="share2" class="mt-lg-5 mb-lg-5 pl-lg-5">
                                  ...
                                  <!-- facebook -->
                                  <a class="facebook" href="https://www.facebook.com/share.php?u={{ route('get_blog.single_blog', $blog_post->slug) }}&title={{ getDataByLang($lang_code,$blog_post->name,$blog_post->name_en) }}" target="blank" rel="nofollow"><i class="fa fa-facebook"></i></a>
                                  ...
                                  <!-- linkedin -->
                                  <a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('get_blog.single_blog', $blog_post->slug) }}&title={{ getDataByLang($lang_code,$blog_post->name,$blog_post->name_en) }}&source=unimall.vn" target="blank" rel="nofollow"><i class="fa fa-linkedin"></i></a>

                                  <!-- pinterest -->
                                  <a class="pinterest" href="https://pinterest.com/pin/create/bookmarklet/?media=media&url={{ route('get_blog.single_blog', $blog_post->slug) }}&is_video=false&description={{ getDataByLang($lang_code,$blog_post->name,$blog_post->name_en) }}" target="blank" rel="nofollow"><i class="fa fa-pinterest-p"></i></a>
                        ...
                        <div class="layout layout--onecol">
                            <div class="container">
                                <div class="col-md-12 mb-lg-5 content-uni">
                                  {!! getDataByLang($lang_code,$blog_post->content,$blog_post->content_en) !!}
                                </div>
                                      ...
                                      <a class="" href="{{ $blog_post_cat != 9 ? getSlugPost($item->slug) : getSlugPolice($item->slug) }}">
                                        <div class="mt-3 mb-3">
                                            ...
                                            <div class="m-category-card__caption mt-2">
                                                ...
                                                {{ getDataByLang($lang_code,desscription_cut($item->name,30),desscription_cut($item->name_en,30)) }}
                                            </span>
                                            </div>
                                        </div>
                                    </a>
