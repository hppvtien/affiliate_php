                            ...
                            <div class="layout__region layout__region--content">
                                <div class="c-page-header c-page-header--light">
                                    <picture class="c-page-header__image">
                                        ...
                                        <img class=" lazyloaded" data-src="/storage/uploads/frontier-prime-cuts-1440x660-1627696550.jpg" alt="{{ trans('title.find_store_spiceclub') }}" src="/storage/uploads/frontier-prime-cuts-1440x660-1627696550.jpg">
                                    </picture>

                                    <div class="c-page-header__content">
                                        <h1 class="c-page-header__headline">{{ trans('title.find_store_spiceclub') }}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <nav class="m-breadcrumb" aria-label="Breadcrumb">
                                        ...
                                        <ol class="m-breadcrumb__list">
                                            ...
                                            <li class="m-breadcrumb__item m-breadcrumb__item--active">
                                                <a class="a-anchor" aria-current="page">{{ trans('title.find_store_spiceclub') }}</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                                                        ...
                                                                        <div class="m-heading get-map-google">
                                                                            <div class="search-input">
                                                                                <div class="field email required">
                                                                                    <div class="control">
                                                                                        <input placeholder="{{ trans('title.search') }}" name="search_name" id="search_name" type="text" class="" data-url="{{ route('get.find') }}">
                                                                                    </div>
                                                                                    <div class="c-filter-bar__sorting">
                                                                                        <div class="">
                                                                                            <select class="m-sort-by__select frontier-custom-sort search_province" data-url="{{ route('get.find') }}" id="order_by" name="search_province" aria-label="Search Province">
                                                                                                <option value="" selected>{{ trans('title.choice_district') }}</option>
                                                                        ...
                                                                        <div id="show-store">
                                                                            ...
                                                                            <div class="m-heading get-map-google" data-lat="{{ $item->store_lat }}" data_lng="{{ $item->store_lng }}">
                                                                                <div class="m-heading__cta">
                                                                                    ...
                                                                                    <p class="m-media-block-aligned__description">{{ trans('title.address') }}: {{ $item->store_address }}</p>
                                                                                    <p class="m-media-block-aligned__description">{{ trans('title.phone_number') }}: {{ $item->store_phone }}</p>
                                                                                    <p class="go-map">{{ trans('title.view_map') }}</p>
                                                                                </div>
                                                                            </div>
                                                                            @empty
