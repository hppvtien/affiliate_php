                        ...
                        <div class="col-md-12 ">
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">{{ trans('title.login_b2b') }}</a>
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">{{ trans('title.regiser_b2b') }}</a>
                                </div>
                            </nav>
                                            ...
                                            <fieldset class="fieldsets create info">
                                                <div class="field field-name-firstname required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
                                                        ...
                                                        <label class="a-form-label m-text-input__label label" for="firstname"><span>{{ trans('title.forget_password') }}</span></label>
                                                    </div>
                                                </div>
                                                <div class="field field-name-firstname required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
                                                ...
                                                <div class="field field-name-firstname required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
                                                        ...
                                                        <label class="a-form-label m-text-input__label label" for="firstname"><span>{{ trans('title.address') }}</span></label>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <fieldset class="fieldsets create account" data-hasrequired="* Required Fields">
                                                ...
                                                <div class="field password required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
                                                        ...
                                                        <label for="password" class="a-form-label m-text-input__label label"><span>{{ trans('title.password') }}</span></label>
                                                    </div>
                                                </div>
                                                <div class="field confirmation required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
                                                        ...
                                                        <label for="password-confirmation" class="a-form-label m-text-input__label label"><span>{{ trans('title.re_password') }}</span></label>
                                                    </div>
                                                </div>
                                                <div class="m-checkbox field choice become_associate_member">
                                                    ...
                                                    <label for="associate_member_requestww" class="label">
                                                        ...
                                                        <span class="m-checkbox__text-label">{{ trans('title.i_agree_with') }} <span><a class="d-inline police-rg" href="{{ route('get.thoa_thuan_su_dung') }}">{{ trans('title.terms_of_use') }}</a></span></span>
                                                    </label>
                                            ...
                                            <div class="actions-toolbar">
                                                <div class="primary">
                                                    <button type="submit" class="a-btn a-btn--primary submit js-register" title="Create an Account">
                                                        <span>{{ trans('title.register') }}</span></button>
                                                </div>
                                                <div class="secondary">
                                                    <a class="a-btn a-btn--text action back" href="{{ route('get.login') }}"><span>{{ trans('title.back') }}</span></a>
                                                </div>
                                            </div>
