                    ...
                    <a class="m-category-card m-category-card--bordered" href="{{ getSlugProduct(getDataByLang($lang_code,$item->slug,$item->slug_en)) }}">
                        <div class="m-category-card__image-wrapper">
                            <picture>
                                ...
                                <img class=" lazyloaded" data-src="{{ pare_url_file($item->thumbnail) }}" alt="{{ getDataByLang($lang_code,$item->name,$item->name_en) }}" src="{{ pare_url_file($item->thumbnail) }}">
                            </picture>
