                    ...
                    <a class="m-category-card m-category-card--bordered" href="{{ getSlugProduct(getDataByLang($lang_code,$item->slug,$item->slug_en)) }}">
                        <div class="m-category-card__image-wrapper">
                            <picture>
                                ...
                                <img class=" lazyloaded" data-src="{{ pare_url_file($item->thumbnail) }}" alt="{{ getDataByLang($lang_code,$item->name,$item->name_en) }}" 
                                src="{{ pare_url_file($item->thumbnail) }}">
                            </picture>
                            <div class="m-category-card__caption product-name-fio can_product_list_1">
                                <span class="m-category-card__caption-text a-folio" style="font-size: 1em!important">{{ getDataByLang($lang_code,$item->name,$item->name_en) }}</span>
                            </div>
                            ...
                            <div class="m-category-card__caption do_cao can_product_list_2">
                                <span class="co_chu_1">{{ countReview($item->id) !=0 ? '('.countReview($item->id).' '.trans('title.rated').')':'' }}</span>
                            </div>
                        </div>
                    </a>
                </li>
