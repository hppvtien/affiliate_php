                                                    ...
                                                    <div class="uni-tex-cat">
                                                        <div class="row cat-desscription">
                                                            <div class="col-md-10 content-uni">
                                                                ...
                                                                {{ getDataByLang($lang_code,$category->desscription,$category->desscription_en) }}
                                                                </p>
                                                                <p style="color: #000; background-color:transparent; text-align:justify;opacity: 1;">
                                                                {!! getDataByLang($lang_code,$category->content,$category->content_en) !!}
                                                                </p>

                                                            </div>
                                                            <div class="col-md-2" 
                                                            style="background-image: url({{ pare_url_file_product($category->thumb_desscription) }}); 
                                                        ...
                                                        <div class="cat-parent" style="padding: 30px 0">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 col-lg-3 col-sm-4 col-12 parent-item">
                                                                    <a class="btn btn-parent" href="{{ getSlugCategory($lang_code,$parentItem->slug,$parentItem->slug_en) }}">
                                                                    ...
                                                                    <div data-product-name="{{ getDataByLang($lang_code,$item->name,$item->name_en) }}" data-product-sku="{{ $item->id }}" class="m-product-card">
                                                                        <div class="m-product-card__content-wrapper">
                                                                            <a class="m-product-card__img-wrapper" href="{{ getSlugProduct(getDataByLang($lang_code,$item->slug,$item->slug_en)) }}" title="{{ getDataByLang($lang_code,$item->name,$item->name_en) }}">
                                                                                <img class="m-product-card__img ls-is-cached lazyloaded" 
                                                                                ...
                                                                                <span class="m-price-lockup__price">
                                                                                    ...
                                                                                    <?php } else { ?>
                                                                                        <?php if (getPriceSale($lang_code,$item->id) > 0) { ?>
                                                                                            ...
                                                                                            <br>
                                                                                            <span class="a-price font-weight-bold price-sale-preview{{ $item->id }}"  data-price{{ $item->id }}="{{ getPriceSaleFe($item->id) == 0 ? getPriceFe($item->id) : getPriceSaleFe($item->id) }}">
