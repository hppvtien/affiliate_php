                    ...
                    <div class="col-md-6 col-12 col-lg-6">
                        <div class="footer-widget footer-left-widget">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="/{{ get_lang() }}/bai-viet/chinh-sach-giao-hang" target="_blank" rel="nofollow">
                            ...
                            <div class="col-12 row">
                                <div class="col-6">
                                    <img class="w-100" src="/images/icon_menu/bo_cong_thuong.png" alt="" class="can_tren_duoi">
                                </div>
                                <div class="col-6">
                                    <a href="https://www.dmca.com/Protection/Status.aspx?ID=f09a95dc-40db-40a5-9296-92...ce.vn/" target="_blank" rel="nofollow "> <img class="w-100" src="https://unispice.vn/wp-content/uploads/2018/02/dmca_protected.png" alt="" class="can_tren_duoi can_tren_duoi2"></a>
                                </div>
                            </div>
                        </div>
