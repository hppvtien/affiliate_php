                                ...
                                @if (get_data_user('web'))
                                    @if(get_data_user('web','type') == 1)
                                        <div class="form-create-account-box">
                                            <h2 class="c-login__block-heading" id="block-customer-login-heading">{{ trans('title.spiceclub_user') }}</h2>
                                        </div>
                                    @else
                                        ...
                                        <div class="form-create-account-box">
                                            ...
                                            <h2 class="c-login__block-heading" id="block-customer-login-heading">{{ trans('title.become_spiceclub') }}</h2>
                                            @else
                                            <h2 class="c-login__block-heading" id="block-customer-login-heading">{{ trans('title.register_spiceclub') }}</h2>
                                                ...
                                                <fieldset class="fieldsets create account" data-hasrequired="* Required Fields">
                                                    ...
                                                    <div class="m-checkbox field choice become_associate_member">
                                                        ...
                                                        <label for="associate_member_request" class="label">
                                                            ...
                                                            <span class="m-checkbox__text-label">{{ trans('title.register_spiceclub') }}</span>
                                                        </label>
                                                    </div>
                                                </fieldset>
                                                <div class="actions-toolbar">
                                ...
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    <div class="form-create-account-box">
                                        ...
                                        <form class="form create account form-create-account" action="{{ route('post.register.spiceclub') }}" method="POST" id="formRegister">
                                            @csrf
                                            <fieldset class="fieldsets create info">
                                                <span class="text-strong gd-danger">{{ trans('title.if_not_account_spiceclub') }}</span>
                                                <div class="field field-name-firstname required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
