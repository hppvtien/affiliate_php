...
@extends('pages.layouts.app_master_frontend') @section('contents')
    ...
    <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>{{ trans('title.image_b2b') }}</h2>
          <p>{{ trans('title.member_b2b') }}</p>
        </div>
      </div>
                            ...
                            <div class="layout__region layout__region--content">
                                <div data-block-plugin-id="inline_block:page_header"
                                    ...
                                    <div class="c-page-header__content">
                                        <h1 class="c-page-header__headline">{{ trans('title.become_mem_spiceclub') }} <br>SPICE CLUB</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="layout__region layout__region--content">
                                <div data-block-plugin-id="inline_block:cta_banner"
                                    ...
                                    <div class="c-cta-banner__content">
                                        <span class="c-cta-banner__heading">{{ trans('title.benefit_spiceclub') }}</span>
                                        <p class="c-cta-banner__subheading"></p>
                                        <a class="a-btn a-btn--primary" href="/dang-ky-spice-club">{{ trans('title.register') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="t-membership-b2c__faq">
                                    <div class="layout layout--onecol c-faq-accordion">
                                        <div class="c-faq-accordion__heading">
                                            <h2 class="c-faq-accordion__title">{{ trans('title.faq_spiceclub') }}</h2>
                                        </div>
