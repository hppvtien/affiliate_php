        ...
        <div class="section-full bg-white pizza-full-menu">
                        ...
                        @foreach ($menu1 as $item)
                            <li class="nav-item item">
                                <a class="item-icon-box nav-link {{ $i == 0 ? 'active' : '' }} render-slug"
                                    data-slug="{{ getSlugCategory(getDataByLang($lang_code,$item->slug,$item->slug_en)) }}" id="pizza-tab{{ $item->id }}"
            ...
            <div class="content-inner can_trai_phai">
                                        ...
                                        <div class="item-box shop-item style2">
                                            <div class="item-img">
                                                <img src="{{ pare_url_file($value1->thumbnail) }}"
                                                    alt="{{ getDataByLang($lang_code,$value1->name,$value1->name_en) }}">
                                            </div>
                                            <div class="item-info text-center">
                                                <!--<h4 class="item-title"><a id="mau_about_link" href="#"></a></h4>-->
                                                <a href="{{ getSlugProduct(getDataByLang($lang_code,$value1->slug,$value1->slug_en)) }}"
                                                    title="{{ getDataByLang($lang_code,$value1->name,$value1->name_en) }}">
                                                    <p class="price text-primary">{{ getDataByLang($lang_code,$value1->name,$value1->name_en) }}</p>
                                                </a>
                                                <div class="cart-btn"><a href="{{ getSlugProduct(getDataByLang($lang_code,$value1->slug,$value1->slug_en)) }}"
                                                        class="btn btnhover radius-xl"><i class="ti-shopping-cart"></i> {{ trans('title.view_more') }}</a></div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                ...
                <div class="content-inner can_trai_phai text-center">
                    <a href="{{ getSlugCategory(getDataByLang($lang_code,$menu1[0]->slug,$menu1[0]->slug_en)) }}" class="btn btn-info text-center show-more-about">{{ trans('title.show_more') }}</a>
                </div>
            </div>
                ...
                <div class="container-fluid" data-aos="fade-up">
                    <div class="row">
                        <div class="col-lg-6 pt-4 pt-lg-0" data-aos="zoom-in" data-aos-delay="100">
                            <div class="about-img" style="padding: 50px;">
                            <h3>{{ getDataByLang($lang_code,$content_page_3->name,$content_page_3->name_en) }}</h3>
                            <p class="fst-italic">
                                {!! getDataByLang($lang_code,$content_page_3->content,$content_page_3->content_en) !!}
                            </p>
                        ...
                        <div class="col-lg-6 pt-4 pt-lg-0" data-aos="zoom-in" data-aos-delay="100">
                            <div class="about-img" style="padding: 50px;">
                            <h3 >{{ getDataByLang($lang_code,$content_page_4->name,$content_page_4->name_en) }}</h3>
                            <p class="fst-italic">
                                {!! getDataByLang($lang_code,$content_page_4->content,$content_page_4->content_en) !!}
                            </p>
                            ...
                            <div class="m-media-block-aligned__image-wrapper">
                                <picture>
                                    ...
                                    <img class="lazyload"
                                        ...
                                        alt="{{ getDataByLang($lang_code,$content_page_5->name,$content_page_5->name_en) }}">
                                </picture>
                            </div>

                            <div class="m-media-block-aligned__content">
                                <div class="m-heading ">
                                    <h2 class="m-heading__headline">{{ getDataByLang($lang_code,$content_page_5->name,$content_page_5->name_en) }}
                                    </h2>
                ...
                <div class="row">
                    @foreach ($blog_post as $item)
                        <div class="col-12 col-md-6 col-lg-3">
                            <a class="" href=" {{ getSlugPost(getDataByLang($lang_code,$item->slug,$item->slug_en)) }}"
                                title="{{ $item->name }}">
