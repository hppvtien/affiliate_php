                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="text-primary">
                                                            ...
                                                            <p class="text-primary" style="height: 28px"><span class="g-price">{{ formatVndProduct($lang_code,$item->price_nosale ) }}</span><span class="font_chu_mau_do"> ( Giảm:-{{ 100-round($item->price*100/$item->price_nosale??0) }}%)</span></p>
                                                            @else
