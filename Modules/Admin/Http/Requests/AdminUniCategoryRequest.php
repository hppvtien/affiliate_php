...
class AdminUniCategoryRequest extends FormRequest
{
    public function rules()
    {
        return [
            ...
            'name_en' => 'required',
            'desscription_en'=>'required|min:100|max:150',
            'slug_en' => 'required|unique:uni_product_category,slug,'.$this->id,
    ...
    public function messages()
    {
        return [
            ...
            'desscription_en.min'=> 'Description must be at least 100 characters',
            'desscription_en.max'=> 'Description is limited to 150 characters',
            ...
            'meta_desscription_en.required' => 'Meta desscription can not empty',
