    ...
    <script>
        $(".keypress-count").keyup(function() {
            var data_lang = $(this).attr('data-lang');
                ...
                $("#count_title_"+data_lang).text("Ký tự: " + ($(this).val().length) + " (Tiêu đề seo 50 - 70 ký tự)");
        ...
        $(".meta_desscription"+data_lang_de).keyup(function() {
            ...
            $("#count_des_"+data_lang_de).text("Ký tự: " + ($(this).val().length) + " (Mô tả seo từ 100 -> 150 ký tự)");
