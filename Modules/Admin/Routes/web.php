...
Route::prefix('vi')->group(function () {
    ...
    Route::prefix('admin')->middleware('checkLoginAdmin')->group(function () {
        Route::group(['middleware' => 'locale'], function () {
            Route::get('change-language/{language}', 'AdminDashboardController@changeLanguageAdmin')
            ...
            Route::prefix('content_page')->group(function () {
                Route::get('/create/{id}', 'AdminContentPageController@create')->name('get_admin.content_page.create')->middleware('permission:page_create|full');
                Route::post('/create/{id}', 'AdminContentPageController@store');
                Route::get('update/{id}', 'AdminContentPageController@edit')->name('get_admin.content_page.edit')->middleware('permission:page_edit|full');
                Route::post('update/{id}', 'AdminContentPageController@update');
                Route::get('delete/{id}', 'AdminContentPageController@delete')->name('get_admin.content_page.delete')->middleware('permission:page_delete|full');
            });
            ...
            Route::prefix('menu_st')->group(function () {
                Route::get('create-menu', 'MenuController@creat_menu')->name('get.creat_menu');
                Route::get('manage-menus/{id?}', 'MenuController@index')->name('manage-menus');
                Route::post('create-menu', 'MenuController@store')->name('create-menu');
                Route::get('add-categories-to-menu', 'MenuController@addCatToMenu')->name('add-categories-to-menu');
                Route::get('add-post-to-menu', 'MenuController@addPostToMenu')->name('add-post-to-menu');
                Route::get('add-custom-link', 'MenuController@addCustomLink')->name('add-custom-link');
                Route::get('update-menu', 'MenuController@updateMenu')->name('update-menu');
                Route::post('update-menuitem/{id}', 'MenuController@updateMenuItem')->name('update-menuitem');
                Route::get('delete-menuitem/{id}/{key}/{in?}', 'MenuController@deleteMenuItem')->name('delete-menuitem');
            ...
            Route::prefix('shortlink')->group(function () {
                Route::get('/', 'ShortLinkController@index')->name('get_admin.shortlink.index');
                Route::get('/create', 'ShortLinkController@create')->name('get_admin.shortlink.create');
                Route::post('/create', 'ShortLinkController@store');
                Route::post('edit/{id}', 'ShortLinkController@edit_flash')->name('get_admin.shortlink.edit');
                Route::get('update/{id}', 'ShortLinkController@edit')->name('get_admin.shortlink.edit');
                Route::post('update/{id}', 'ShortLinkController@update');
                Route::get('delete/{id}', 'ShortLinkController@delete')->name('get_admin.shortlink.delete');
                // Route::get('manage-menus/{id?}', [MenuController::class, 'index']);
            });
