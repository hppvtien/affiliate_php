...
Route::group(['middleware' => ['locale', 'checkLoginUser']], function() {

    
        Route::prefix('{locale?}/user')->group(function() {
            ...
            // Route::middleware('checkLoginUser')->group(function () {
                ...
                Route::post('updateCartByLang.html', 'UserCartController@updateCartByLang')->name('get_user.updatecartbylang');
