            ...
            <div class="header-info-wrapper">
                ...
                <ul class="site-header-cart-v2 menu">
                    <li class="cart-content ">
                        ...
                        <a href="{{ route('get_user.cart',app()->getLocale()) }}" class="a-icon-text-btn a-icon-text-btn--icon-only c-header__minicart-button js-minicart__trigger" id="count-cart">
                        ...
                        <div class="dropdown" id="uni">
                            ...
                            <a class="dropdown-item" href="{{ route('get_user.dashboard') }}">{{ trans('title.account') }}</a>
...
<div style="position: relative;z-index: 99999999;background:#0b2d25">
    <div class="search-full-view">
        <div class="input-group">
            <form action="{{ route('get.search',['language'=>app()->getlocale()]) }}" autocomplete="off">
