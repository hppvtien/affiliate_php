...
<div class="zeynep">
    <div class="col-md-12 col-xs-12 border_menu_mobile">
        ...
        <div class="col-lg-12 kich_co">
            ...
            <a class="col-md-12 row" href="{{ route('get_user.dashboard') }}"><span class="icon-account font_icon_new"><b>{{ trans('title.m_account') }}</b> </span></a>
            @else
            ...
            <a class="col-md-12 row" href="{{ route('get_user.myfavorites',app()->getLocale()) }}" >
            ...
            <a class="col-md-12 row" href="{{ route('get_user.cart',app()->getLocale()) }}" rel="nofollow">
    ...
    <ul>
        ...
        <li class="has-submenu">
            <a href="{{ getSlugCategory($item->slug) }}"><img style="float: left;padding: 5px;" width="30px" src="{{ pare_url_file_product($item->icon_thumb) }}" alt="">
            ...
            <div id="menu_{{ $item->id }}" class="submenu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ getSlugCategory($vl->slug) }}">{{ getDataByLang($lang_code,$vl->name,$vl->name_en) }}</a>
                    </li>
                    @endforeach
                </ul>
