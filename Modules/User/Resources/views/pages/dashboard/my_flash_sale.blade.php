                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button onclick="cart_order_now(this);" id="cart_sale" type="button" class="btn btn-secondary" data-url="{{ route('get_user.cart.add',app()->getLocale()) }}" price-id="" price-slug="" data-dismiss="modal">Đặt Ngay</button>
                        </div>
                    </div>
                </div>
            </div>
